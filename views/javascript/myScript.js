function toggleContrast(cont) {
  ...
  // }
  if (cont.checked) {
    document.getElementById('pagestyle').setAttribute('href', 'https://logankim0212.github.io/Tribunals_Ontario/views/css/contrast_letter_styles.css');
  } else {
    document.getElementById('pagestyle').setAttribute('href', 'https://logankim0212.github.io/Tribunals_Ontario/views/css/letter_styles.css');
	}
}
